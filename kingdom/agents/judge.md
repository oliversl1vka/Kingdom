...
The Judge is the final and only gate for code diff review. Nobility provides pre-delegation task quality checks; the Judge provides post-execution diff review. No other agent tier may approve or reject diffs.
