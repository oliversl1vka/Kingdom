// Submit the decree for Run 8 - same 20 pixel art tasks
const http = require('http');

const decree = {
  objective: "Pixel Art Castle UI Enhancement - Run 8 (full file context)",
  tasks: [
    {
    ...
    },
    {
      ...
      assigned_tier: "knight",
      context_refs: [{ file: "packages/ui/src/engine/pixel-characters.ts", startLine: 1, endLine: 9999 },
                     { file: "packages/ui/src/scenes/agents.tsx", startLine: 1, endLine: 9999 }],
